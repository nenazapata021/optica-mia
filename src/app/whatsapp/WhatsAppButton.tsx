  ...
  if (!abierto) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 flex items-center justify-center rounded-full bg-[#25D366] p-3.5 text-white shadow-lg transition hover:bg-[#20BD5C] hover:scale-105 active:scale-95"
