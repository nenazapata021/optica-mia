...
import { ShoppingCart, Package, Sun, Eye, Trash2, BarChart3, Table, ClipboardList, LogOut, Plus, Lock } from "lucide-react";
      ...
      {!authed ? (
        <div className="flex w-full items-center justify-center px-4">
          <form onSubmit={handleLogin} className="w-full max-w-sm rounded-2xl bg-white p-8 shadow-lg">
            ...
            <p className="mb-6 text-center text-sm text-gray-500">Ingresa tus credenciales para continuar</p>
            <input
              type="email"
              value={email}
            ...
            <input
              ...
              className="mt-3 w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm outline-none transition focus:border-[#D4AF37] focus:ring-1 focus:ring-[#D4AF37]"
              disabled={loading}
            />
